...
const translations = {
  en: {
    ...
    "home.about.donations.description":
      "Money donations from generous community members enable us to purchase fresh groceries and essential items for our weekly distributions. Combined with proceeds from our three thrift stores throughout Herzeliya, we create a sustainable funding model that ensures consistent weekly food distribution to those who need it most. Every donation, whether large or small, directly translates into nutritious meals for single-parent families, large families, and elderly individuals across our community.",
    "home.about.distribution.title": "Volunteer Distribution Network",
    "home.about.distribution.description":
      "Our dedicated distribution volunteers follow carefully planned weekly routes throughout Herzeliya, ensuring reliable and dignified delivery to families in need. Each volunteer covers specific neighborhoods, building personal relationships with recipients and maintaining consistent service. The more volunteers we recruit and train, the more families we can reach and support with regular food assistance. Our distribution network operates year-round, adapting to seasonal needs and special circumstances to maintain uninterrupted support for our community's most vulnerable members.",
    ...
    "home.shops.herzliya1.title": "Herzeliya Center Store",
    "home.shops.herzliya1.hours": "Sun-Thu: 9:00-18:00, Fri: 9:00-14:00",
    "home.shops.herzliya1.manager": "Rachel Cohen",
    "home.shops.herzliya1.phone": "09-956-1234",
    "home.shops.herzliya1.items": "Women's clothing, handbags, jewelry, shoes, home decor",
    "home.shops.herzliya2.title": "Herzeliya Pituach Store",
    "home.shops.herzliya2.hours": "Sun-Thu: 10:00-19:00, Fri: 9:00-13:00",
    "home.shops.herzliya2.manager": "David Levi",
    "home.shops.herzliya2.phone": "09-956-5678",
    "home.shops.herzliya2.items": "Men's clothing, children's toys, books, electronics, sports equipment",
    "home.shops.herzliya3.title": "Old Herzeliya Store",
    "home.shops.herzliya3.hours": "Sun-Thu: 8:30-17:30, Fri: 8:30-13:30",
    "home.shops.herzliya3.manager": "Sarah Goldstein",
    "home.shops.herzliya3.phone": "09-956-9012",
    "home.shops.herzliya3.items": "Mixed clothing, household items, kitchenware, vintage finds",
  },
  he: {
    ...
    "home.about.donations.description":
      "תרומות כספיות מחברי קהילה נדיבים מאפשרות לנו לרכוש מצרכים טריים ופריטים חיוניים לחלוקות השבועיות שלנו. בשילוב עם הכנסות משלוש חנויות היד השנייה שלנו ברחבי הרצליה, אנו יוצרים מודל מימון קיים המבטיח חלוקת מזון שבועית עקבית לאלה הזקוקים לכך ביותר. כל תרומה, בין אם גדולה או קטנה, מתורגמת ישירות לארוחות מזינות למשפחות חד הוריות, משפחות מרובות ילדים וקשישים ברחבי הקהילה שלנו.",
    "home.about.distribution.title": "רשת חלוקה מתנדבת",
    "home.about.distribution.description":
      "מתנדבי החלוקה המסורים שלנו עוקבים אחר מסלולים שבועיים מתוכננים בקפידה ברחבי הרצליה, ומבטיחים משלוח אמין ומכובד למשפחות הזקוקות לעזרה. כל מתנדב מכסה שכונות ספציפיות, בונה קשרים אישיים עם המקבלים ושומר על שירות עקבי. ככל שאנו מגייסים ומכשירים יותר מתנדבים, כך נוכל להגיע ולתמוך ביותר משפחות עם סיוע מזון קבוע. רשת החלוקה שלנו פועלת כל השנה, מתאימה עצמה לצרכים עונתיים ונסיבות מיוחדות כדי לשמור על תמיכה בלתי פסוקה לחברי הקהילה הפגיעים ביותר.",
    ...
    "home.shops.callManager": "התקשרו למנהלת",
    "home.shops.openingHours": "שעות פתיחה",
    "home.shops.manager": "מנהלת",
    "home.shops.mainItems": "פריטים עיקריים",
    "home.shops.herzliya1.title": "חנות מרכז הרצליה",
    "home.shops.herzliya1.hours": "א'-ה': 9:00-18:00, ו': 9:00-14:00",
    "home.shops.herzliya1.manager": "רחל כהן",
    "home.shops.herzliya1.phone": "09-956-1234",
    "home.shops.herzliya1.items": "בגדי נשים, תיקים, תכשיטים, נעליים, עיצוב הבית",
    "home.shops.herzliya2.title": "חנות הרצליה פיתוח",
    "home.shops.herzliya2.hours": "א'-ה': 10:00-19:00, ו': 9:00-13:00",
    "home.shops.herzliya2.manager": "דוד לוי",
    "home.shops.herzliya2.phone": "09-956-5678",
    "home.shops.herzliya2.items": "בגדי גברים, צעצועי ילדים, ספרים, אלקטרוניקה, ציוד ספורט",
    "home.shops.herzliya3.title": "חנות הרצליה הישנה",
    "home.shops.herzliya3.hours": "א'-ה': 8:30-17:30, ו': 8:30-13:30",
    "home.shops.herzliya3.manager": "שרה גולדשטיין",
    "home.shops.herzliya3.phone": "09-956-9012",
    "home.shops.herzliya3.items": "בגדים מעורבים, כלי בית, כלי מטבח, פריטים וינטג'",
  },
}
